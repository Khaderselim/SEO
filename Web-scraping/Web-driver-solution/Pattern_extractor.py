...
def extract_pattern(url: str):
    ...
    with sync_playwright() as playwright:
        browser = playwright.chromium.launch(proxy={"server": "http://127.0.0.1:8899"}, headless=False)# Set headless to True for faster execution, but it's easily blocked by some sites
